...
ABILITY_DEFS: Dict[str, List[Dict[str, Any]]] = {
    "warrior": [
        ...
        {"id": "shield_wall", "name": "Shield Wall", "type": "effect", "effect": "shield_wall", "cooldown": 4,
         "effect_target": "self", "reduction_pct": 0.50, "reflect_pct": 0.25, "hits_left": 2},
        {"id": "execute", "name": "Execute", "type": "attack", "damage_multiplier": 1.2, "cooldown": 4,
    ...
    "rogue": [
        ...
        {"id": "backstab", "name": "Backstab", "type": "attack", "damage_multiplier": 1.35, "cooldown": 2,
        ...
        {"id": "shadowstep", "name": "Shadowstep", "type": "attack", "damage_multiplier": 0.85, "cooldown": 3,
